...
<header class="container-fluid mt-5 ml-5 pt-3 pl-5">
    <div class="row">
        <div class="col-2">
            ...
            $result = mysqli_query($link, "SELECT * FROM pengguna WHERE nik = $nik");
            ...
            if($_POST['register']){
                ...
                if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                    if($ukuran < 10000000){
                        ...
                        $query = mysqli_query("INSERT INTO pengguna ('photo') VALUES ('$nama')");
                        if($query){
            ...
            $gambar = mysqli_query("SELECT * FROM pengguna");
            $d = mysqli_fetch_array($gambar);

            ?>
            <img src="<?php echo "foto/".$d['photo']; ?>" alt="" width="200" height="200" class="img-thumbnail">
            <h4 style="text-align: center; padding-top: 10px;"><?php echo $data['nama_lengkap'];?></h4>
        </div>
        <div class="col-10">
            <h1>Peduli Diri</h1>
...
<article class="container-fluid pb-5 mb-5">
    <main class="mt-5 pt-3">
        <div class="border border-dark" style="margin-top: 25px; margin-right: 15%; margin-left: 15%;">
            <p style="margin-top: 20px; margin-left: 20px;">Selamat datang <span><?php echo $data['nama_lengkap'];?></span> di aplikasi Peduli Diri</p>
            <br>
            <br>
            <br>
            <br>
