...
<article class="container-fluid pb-5 mb-5">
    <main class="mt-5 pt-3">
        <div class="border border-dark" style="margin-top: 25px; margin-right: 15%; margin-left: 15%;">
            <div style="margin-left: 49px; margin-top: 30px; margin-right: 27px; width: 90%;">
                <form action="pengaturan.php" method="post">
                    ...
                    <input type="submit" class="btn btn-primary" name="submit" value="Simpan" style="margin-left: 91%; margin-bottom: 15px;">
                </form>
            </div>
        </div>
    </main>
